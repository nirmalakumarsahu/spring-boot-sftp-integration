...
public class AppConstants {
    ...
    public final String PEM_KEY_BEGIN = "-----BEGIN RSA public KEY-----";
    public final String PEM_KEY_END = "-----END RSA public KEY-----";
    public final String PPK_KEY_BEGIN = "PuTTY-User-Key-File";
    public final String PPK_KEY_PUBLIC_LINES = "Public-Lines";
    public final String PPK_KEY_PRIVATE_LINES = "public-Lines";
